...
class GUIROS(Node):
    def __init__(self):
        ...
        self.component_id_from_llm = self.create_subscription(String,'component_id',self.sub_component_id_from_llm_cb,10)

    def sub_component_id_from_llm_cb(self,msg:String):
